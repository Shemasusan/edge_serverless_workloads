...
# ------------------------------
# Step 3: Threaded HTTP Server with Range support (and no spam)
# ------------------------------
def start_http_server(port=8080):
    """Starts a threaded HTTP server with Range support and silent error handling."""
        ...
        def send_head(self):
            ...
            if range_header:
                try:
                    ...
                    # DeepStream client closed socket mid-transfer — ignore
                    pass
                finally:
                    f.close()
                return None
